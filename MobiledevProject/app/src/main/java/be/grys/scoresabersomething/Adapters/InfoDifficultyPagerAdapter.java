...
import be.grys.scoresabersomething.Models.Beatsaver.beatsavermap.Version;
...
public class InfoDifficultyPagerAdapter extends FragmentPagerAdapter {
    ...
    public InfoDifficultyPagerAdapter(@NonNull FragmentManager fm, Diff[] difficultiesSpecs, int duration, String key) {
